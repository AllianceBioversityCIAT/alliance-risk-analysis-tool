...
jest.mock('@/components/ui/dropdown-menu', () => {
  return {
    ...
    DropdownMenuItem: ({ children, onClick }: any) => <div data-testid="dropdown-menu-item" onClick={onClick}>{children}</div>,
  };
});
...
describe('AssessmentTable', () => {
  ...
  it('shows empty state when no assessments match', () => {
    ...
    expect(screen.getByText(/No results for “No Match”/i)).toBeInTheDocument();
  });
});
