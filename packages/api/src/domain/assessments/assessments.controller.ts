...
export class AssessmentsController {
  ...
  @Post(':id/documents/parse-all')
  @HttpCode(HttpStatus.ACCEPTED)
  triggerParseAll(
    @Param('id', ParseUUIDPipe) id: string,
    @CurrentUser() user: UserClaims,
  ) {
    return this.assessmentsService.triggerParseAllDocuments(id, user.userId);
  }
  ...
  deleteDocument(
    ...
    return this.assessmentsService.deleteDocument(id, documentId, user.userId);
  }

  @Get(':id/merged-content')
  getMergedContent(
    @Param('id', ParseUUIDPipe) id: string,
    @CurrentUser() user: UserClaims,
  ) {
    return this.assessmentsService.getMergedContent(id, user.userId);
  }
